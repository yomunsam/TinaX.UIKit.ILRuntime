# TinaX Framework - 针对ILRuntime的UIKit扩展
...
`TinaX.UIKit.ILRuntime` 是 针对 [TinaX.ILRuntime](https://github.com/yomunsam/TinaX.ILRuntime)的扩展包，用于在热更新代码中更加愉快的使用UIKit.
...
namespace Nekonya.Example
{
    public class AppBootstrap : IXBootstrap
    {
        public void OnInit(IXCore core)
        {
            ...
            xil.RegisterUIKit(); //扩展方法，来自命名空间 "TinaX.XILRuntime.Registers"
        }
...
如果您想手动指定安装某个本本, 您可以使用 release tag, 例如 `#6.6.1`. 或访问Release页面了解细节: [https://github.com/yomunsam/TinaX.UIKit.ILRuntime/releases](https://github.com/yomunsam/TinaX.UIKit.ILRuntime/releases)
